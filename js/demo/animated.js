...
export default class App extends Component {
  ...
  render() {
    ...
    // it back to 0.
    // 合并动画值 这里是为了兼容ios 如果不需要兼容ios 那么直接写 congst scrollY= this.state.scrollY
      ...
      <View style={styles.fill}>
        ...
        <Animated.ScrollView
          ...
          onScroll={e => {
            ...
            // 把e.nativeEvent.contentOffset.y值映射到this.state.scrollY上面
            Animated.event([
              { nativeEvent: { contentOffset: { y: this.state.scrollY } } }
            ]).call(this, e);
          }}
        ...
        >
          <Animated.Image
            style={[
              ...
              {
                transform: [{ translateX: avatarTranslate }]
              }
            ]}
