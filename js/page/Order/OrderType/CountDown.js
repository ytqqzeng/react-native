  ...
  render() {
    ...
    return (
      <View style={[styles.container, this.props.containerStyle]}>
        {countDown.days > 0 ? (
          <Text style={this.props.daysStyle}>
            {this.leadingZeros(countDown.days) + days}
          </Text>
        ) : null}
        <Text style={[styles.defaultTime, this.props.hoursStyle]}>
          {this.leadingZeros(countDown.hours) + "小时"}
        </Text>
        <Text style={[styles.defaultTime, this.props.minsStyle]}>
          {this.leadingZeros(countDown.min) + "分"}
        </Text>
        <Text style={[styles.defaultTime, this.props.secsStyle]}>
          {this.leadingZeros(countDown.sec) + "秒"}
        </Text>
      </View>
    );
  }
